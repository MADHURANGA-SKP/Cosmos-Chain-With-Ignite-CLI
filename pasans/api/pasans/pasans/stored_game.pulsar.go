...
func init() {
	...
	md_StoredGame = File_pasans_pasans_stored_game_proto.Messages().ByName("StoredGame")
...
func (x *StoredGame) slowProtoReflect() protoreflect.Message {
	mi := &file_pasans_pasans_stored_game_proto_msgTypes[0]
...
func (x *fastReflection_StoredGame) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "pasans.pasans.StoredGame.index":
		return x.Index != ""
	case "pasans.pasans.StoredGame.board":
		return x.Board != ""
	case "pasans.pasans.StoredGame.turn":
		return x.Turn != ""
	case "pasans.pasans.StoredGame.black":
		return x.Black != ""
	case "pasans.pasans.StoredGame.red":
		return x.Red != ""
	case "pasans.pasans.StoredGame.winner":
		return x.Winner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pasans.pasans.StoredGame"))
		}
		panic(fmt.Errorf("message pasans.pasans.StoredGame does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StoredGame) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message pasans.pasans.StoredGame does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StoredGame) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "pasans.pasans.StoredGame.index":
		panic(fmt.Errorf("field index of message pasans.pasans.StoredGame is not mutable"))
	case "pasans.pasans.StoredGame.board":
		panic(fmt.Errorf("field board of message pasans.pasans.StoredGame is not mutable"))
	case "pasans.pasans.StoredGame.turn":
		panic(fmt.Errorf("field turn of message pasans.pasans.StoredGame is not mutable"))
	case "pasans.pasans.StoredGame.black":
		panic(fmt.Errorf("field black of message pasans.pasans.StoredGame is not mutable"))
	case "pasans.pasans.StoredGame.red":
		panic(fmt.Errorf("field red of message pasans.pasans.StoredGame is not mutable"))
	case "pasans.pasans.StoredGame.winner":
		panic(fmt.Errorf("field winner of message pasans.pasans.StoredGame is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: pasans.pasans.StoredGame"))
		}
...
func (x *fastReflection_StoredGame) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in pasans.pasans.StoredGame", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: pasans/pasans/stored_game.proto
...
func (*StoredGame) Descriptor() ([]byte, []int) {
	return file_pasans_pasans_stored_game_proto_rawDescGZIP(), []int{0}
}
...
var File_pasans_pasans_stored_game_proto protoreflect.FileDescriptor

var file_pasans_pasans_stored_game_proto_rawDesc = []byte{
	,
}

var (
	file_pasans_pasans_stored_game_proto_rawDescOnce sync.Once
	file_pasans_pasans_stored_game_proto_rawDescData = file_pasans_pasans_stored_game_proto_rawDesc
)

func file_pasans_pasans_stored_game_proto_rawDescGZIP() []byte {
	file_pasans_pasans_stored_game_proto_rawDescOnce.Do(func() {
		file_pasans_pasans_stored_game_proto_rawDescData = protoimpl.X.CompressGZIP(file_pasans_pasans_stored_game_proto_rawDescData)
	})
	return file_pasans_pasans_stored_game_proto_rawDescData
}

var file_pasans_pasans_stored_game_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_pasans_pasans_stored_game_proto_goTypes = []interface{}{
	(*StoredGame)(nil), // 0: pasans.pasans.StoredGame
}
var file_pasans_pasans_stored_game_proto_depIdxs = []int32{
...
func init() { file_pasans_pasans_stored_game_proto_init() }
func file_pasans_pasans_stored_game_proto_init() {
	if File_pasans_pasans_stored_game_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pasans_pasans_stored_game_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pasans_pasans_stored_game_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pasans_pasans_stored_game_proto_goTypes,
		DependencyIndexes: file_pasans_pasans_stored_game_proto_depIdxs,
		MessageInfos:      file_pasans_pasans_stored_game_proto_msgTypes,
	}.Build()
	File_pasans_pasans_stored_game_proto = out.File
	file_pasans_pasans_stored_game_proto_rawDesc = nil
	file_pasans_pasans_stored_game_proto_goTypes = nil
	file_pasans_pasans_stored_game_proto_depIdxs = nil
}
